...
void ghifile1(int* n, double x[], double  y[][SO_MOC_LON_NHAT]);
void ghifile2(int n, double x[], double  y[][SO_MOC_LON_NHAT]);
void ghifile3(int n, double x[], double  y[][SO_MOC_LON_NHAT]);
void ghifile4(int n, double x[], double  y[][SO_MOC_LON_NHAT]);
...
void hoocle(double arr[], int n, int p) {
	...
	ghifilehoocle(n, mangKQ, p1, arr, &c);
	free(mangKQ);
...
void ghifile2(int n, double x[], double  y[][SO_MOC_LON_NHAT]) {
	...
	for (i = 0; i < n; i++)
	{
		fprintf(fout2, "\t%0.2lf", x[i]);
		for (j = 0; j < n - i; j++)
		{
			fprintf(fout2, "\t%0.2lf", y[i][j]);
		}
		fprintf(fout2, "\n");
	}
	fprintf(fout2, "\n\n");
...
void ghifile4(int n, double x[], double  y[][SO_MOC_LON_NHAT]) {
	...
	fprintf(fout4, "\n");
	for (i = 0; i < n; i++) {
		fprintf(fout4, "\t%0.2lf", x[i]);
		for (j = 0; j < n - i; j++)
		{
			fprintf(fout4, "\t%0.2lf", y[i][j]);
		}
		fprintf(fout4, "\n");
	}
	fprintf(fout4, "\n\n");
